...
public class NameChecker {
     ...
     *
     * <ul>
     * <li>类或结构：符合坨式命名法，首字符大写
     * <li>方法：符合坨式命名法，首字母小写
     * <li>字段：
     * <ul>
     * <li>类、实例变量：符合坨式命名法，首字母小写
     * <li>常量：要求全部大写
     * </ul>
     * </ul>
     */
    ...
    private class NameCheckScanner extends ElementScanner6<Void, Void> {
        ...
        public Void visitVariable(VariableElement e, Void p) {
            // 如果这个Variable是枚举或者常量，则按大写命名检查，否则按照坨式命名法规则检查
        ...
        private boolean heuristicallyConstant(VariableElement e) {
            if (e.getEnclosingElement().getKind() == ElementKind.INTERFACE) {
                ...
                return e.getKind() == ElementKind.FIELD && e.getModifiers().containsAll(EnumSet.of(PUBLIC, STATIC, FINAL));
        }

        /**
         * 检查传入的Element是否符合坨式命名法，如果不符合，则输出警告信息
         */
        private void checkCamelCase(Element e, boolean initialCaps) {
            ...
            if (!conventional) {
                messager.printMessage(Diagnostic.Kind.WARNING, "名称" + name + "应当符合坨式命名法（Camel Case Names)", e);
            }
        }
